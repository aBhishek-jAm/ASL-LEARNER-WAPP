...
label_map = {0: 'aunt', 1: 'hi', 2: 'thankyou',3:'please',4:'eat',5:'enri_media',6:'father',7:'help',8:'i_love_you',9:'learn',10:'mother',11:'name',12:'want',13:'water'}  # Update with actual word labels
        ...
        if not success:
            ...
            if result.multi_hand_landmarks:
                for hand_landmarks in result.multi_hand_landmarks:
                    ...
                    prediction = intermediate_model.predict(landmarks)  # This should match the expected input shape (None, 63)
